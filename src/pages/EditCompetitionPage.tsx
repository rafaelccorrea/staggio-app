...
import EditCompetitionShimmer from '../components/shimmer/EditCompetitionShimmer';
...
export const EditCompetitionPage: React.FC = () => {
  ...
  const loadCompetition = useCallback(async () => {
    ...
    try {
      const data = await competitionService.findById(id);
      setCompetition(data);
      ...
      setFormData({
        ...
        useCompanyPointsConfig: data.useCompanyPointsConfig || false,
        autoStart: data.autoStart || false,
        autoEnd: data.autoEnd || false,
        minParticipants: data.minParticipants?.toString() || '',
        maxParticipants: data.maxParticipants?.toString() || '',
      });
      setSelectedUserIds(data.participantUserIds ?? []);
      setSelectedTeamIds(data.participantTeamIds ?? []);
      setLimitUsers((data.participantUserIds?.length ?? 0) > 0);
      setLimitTeams((data.participantTeamIds?.length ?? 0) > 0);
    } catch (error: any) {
      toast.error(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Se a competição ainda não foi iniciada, validar data de início
    if (competitionStatus === 'scheduled' && startDate < now) {
    ...
    // Se a competição está em andamento, não permitir alterar data de início para o futuro
    if (competitionStatus === 'active' && startDate > now) {
      toast.error(
        'Não é possível alterar a data de início de uma competição em andamento para o futuro!'
      );
      return;
    }
    ...
    try {
      ...
      await competitionService.update(id, competitionData);

      toast.success('Competição atualizada com sucesso!');
      navigate('/competitions');
    } catch (error: any) {
      toast.error(
        error.response?.data?.message || 'Erro ao atualizar competição'
      );
      console.error(error);
    } finally {
      setLoading(false);
  ...
  return (
    <Layout>
      <SimplePageContainer>
        <SimpleHeader>
          <div>
            <SimpleTitle>Editar Competição</SimpleTitle>
            <SimpleSubtitle>
            ...
            <FieldContainer>
              <FieldLabelWithTooltip>
                ...
                <TooltipWrapper>
                  <TooltipIcon />
                  <TooltipContent>
                    Nome exibido em dashboards, relatórios e notificações.
                  </TooltipContent>
                </TooltipWrapper>
              </FieldLabelWithTooltip>
              <FieldInput
            ...
            <FieldContainer>
              <FieldLabelWithTooltip>
                ...
                <TooltipWrapper>
                  <TooltipIcon />
                  <TooltipContent>
                    Altera o formato do ranking: individual, equipes ou formato
                    misto.
                  </TooltipContent>
                </TooltipWrapper>
              </FieldLabelWithTooltip>
            ...
            <FieldContainer>
              <FieldLabelWithTooltip>
                ...
                <TooltipWrapper>
                  <TooltipIcon />
                  <TooltipContent>
                    Use para orientar os participantes sobre metas e premiações.
                  </TooltipContent>
                </TooltipWrapper>
              </FieldLabelWithTooltip>
              <TextArea
            ...
            <FieldContainer>
              <FieldLabelWithTooltip>
                ...
                <TooltipWrapper>
                  <TooltipIcon />
                  <TooltipContent>
                    Momento em que os pontos começam a ser contabilizados para
                    esta competição.
                  </TooltipContent>
                </TooltipWrapper>
              </FieldLabelWithTooltip>
            ...
            <FieldContainer>
              <FieldLabelWithTooltip>
                ...
                <TooltipWrapper>
                  <TooltipIcon />
                  <TooltipContent>
                    Após esta data a competição é considerada encerrada.
                  </TooltipContent>
                </TooltipWrapper>
              </FieldLabelWithTooltip>
              <FieldInput
            ...
            <FieldContainer>
              <FieldLabelWithTooltip>
                ...
                <TooltipWrapper>
                  <TooltipIcon />
                  <TooltipContent>
                    Quantidade mínima recomendada para validar a disputa
                    (opcional).
                  </TooltipContent>
                </TooltipWrapper>
              </FieldLabelWithTooltip>
            ...
            <FieldContainer>
              <FieldLabelWithTooltip>
                ...
                <TooltipWrapper>
                  <TooltipIcon />
                  <TooltipContent>
                    Limite máximo permitido. Deixe vazio para não limitar.
                  </TooltipContent>
                </TooltipWrapper>
              </FieldLabelWithTooltip>
              <FieldInput
                ...
                <ParticipantsHeader>
                  ...
                  <ToggleWrapper>
                    ...
                    <TooltipWrapper>
                      ...
                      <TooltipContent>
                        Marque para restringir a competição a corretores
                        selecionados.
                      </TooltipContent>
                    </TooltipWrapper>
                  </ToggleWrapper>
                ...
                <ParticipantsHeader>
                  ...
                  <ToggleWrapper>
                    ...
                    <TooltipWrapper>
                      ...
                      <TooltipContent>
                        Marque para incluir apenas algumas equipes na disputa.
                      </TooltipContent>
                    </TooltipWrapper>
                  </ToggleWrapper>
                </ParticipantsHeader>
