...
interface EditPropertyExpenseModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: UpdatePropertyExpenseData) => Promise<void>;
...
export const EditPropertyExpenseModal: React.FC<
  EditPropertyExpenseModalProps
> = ({ isOpen, onClose, onSave, expense, propertyId }) => {
  const [formData, setFormData] = useState<UpdatePropertyExpenseData>({
    title: expense.title,
    ...
    notificationAdvanceDays: expense.notificationAdvanceDays,
  ...
  const handleChange = (field: keyof UpdatePropertyExpenseData, value: any) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data: UpdatePropertyExpenseData = {
        ...formData,
