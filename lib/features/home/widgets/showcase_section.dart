        ...
        VideoCarousel(
          videos: [
            ...
            VideoItem(
              ...
              prompt: '30-second cinematic real estate video of a modern house for sale. Shot breakdown: 5s smooth drone shot approaching the property, 8s exterior wide angles showcasing architecture and landscaping, 10s interior walkthrough, 7s detail shots of premium finishes.',
            ),
            VideoItem(
              ...
              prompt: '30-second architectural transformation video. Single fixed camera angle throughout. Consistent daylight lighting and same sun direction. Stage 1 (10s): empty grassy lot. Stage 2 (10s): foundation and structure. Stage 3 (10s): finished modern house with landscaping.',
            ),
          ],
        ),
        const SizedBox(height: 20),
